...
class DataValidation:
    ...
    def initiate_data_validation(self) -> artifact_entity.DataValidationArtifact:
        try:
            ...
            exclude_col = ['class']
            base_df = utils.convert_columns_float(df = base_df, exclude_col = exclude_col)
            train_df = utils.convert_columns_float(df = train_df, exclude_col = exclude_col)
            test_df = utils.convert_columns_float(df = test_df, exclude_col = exclude_col)
